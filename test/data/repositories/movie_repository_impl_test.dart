...
void main() {
  ...
  const tMovieModel = MovieModel(
    ...
    'After being bitten by a genetically altered spider, '
        'nerdy high school student Peter Parker is endowed with amazing powers to become the Amazing superhero known as Spider-Man.',
  ...
  final tMovie = Movie(
    ...
    id: 557,
    overview:
    'After being bitten by a genetically altered spider, nerdy high school student '
        'Peter Parker is endowed with amazing powers to become the Amazing superhero known as Spider-Man.',
    releaseDate: '2002-05-01',
    backdropPath: '/muth4OYamXf41G2evdrLEg8d3om.jpg',
    originalTitle: 'Spider-Man',
    posterPath: '/rweIrveL43TaxUN0akQEaAXL6x0.jpg',
  ...
  group('save watchlist', () {
    ...
    test('should return DatabaseFailure when saving unsuccessful',
            () async {
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful',
      ...
      // act
      final result = await repository
          .removeWatchlist(testMovieDetail);
    ...
    test('should return DatabaseFailure when remove unsuccessful',
            () async {
