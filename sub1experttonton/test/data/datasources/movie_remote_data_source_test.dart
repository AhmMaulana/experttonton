...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
          ...
          when(mockHttpClient
              ...
              .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/now_playing.json'),
                  200)
          );
  ...
  group('get Popular Movies', () {
    final tMovieList =
        MovieResponse.fromJson(json.decode(
            readJson('dummy_data/movie/popular.json')
        ))
            .movieList;
    ...
    test('should return list of movies when response is success (200)',
          ...
          when(mockHttpClient.get(Uri.parse(
              ...
              .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/movie/popular.json'),
                  200)
          );
  ...
  group('get Top Rated Movies', () {
    final tMovieList = MovieResponse.fromJson(
        json.decode(readJson(
            'dummy_data/movie/top_rated.json')
        ))
        .movieList;


    test('should return list of movies when response code is 200 ',
            () async {
      ...
      when(mockHttpClient.get(Uri.parse(
          ...
          .thenAnswer((_) async =>
          http.Response(readJson('dummy_data/movie/top_rated.json'),
              200)
      );
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200',
      ...
      // arrange
      when(mockHttpClient.get(Uri.parse(
          '$baseUrl/movie/$tId?$apiKey')
      ))
          .thenAnswer((_) async =>
          http.Response(readJson('dummy_data/movie/movie_detail.json'),
              200));
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(
        json.decode(readJson(
            'dummy_data/movie/movie_recommendations.json')
        ))
        .movieList;
    const tId = 1;
    ...
    test('should return list of Movie Model when the response code is 200',
          ...
          when(mockHttpClient
              .get(Uri.parse(
              '$baseUrl/movie/$tId/recommendations?$apiKey')
          ))
              .thenAnswer((_) async => http.Response(
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(
        json.decode(readJson(
            'dummy_data/movie/search_spiderman_movie.json')
        ))
        .movieList;
    ...
    test('should return list of movies when response code is 200',
      ...
      when(mockHttpClient
          .get(Uri.parse(
          '$baseUrl/search/movie?$apiKey&query=$tQuery')
      ))
          .thenAnswer((_) async => http.Response(
