...
class UnitvyDetailResponse
    extends Equatable {

  const UnitvyDetailResponse(
      {
    required this
        .backdropPath,
  ...
  factory UnitvyDetailResponse
      .fromJson(Map
        <String, dynamic>json
      )
          => UnitvyDetailResponse(
    ...
    [
      "genres"
        ...
        GenreModel.fromJson(x)
            ...
            numberOfEpisodes: json
            [
              "number_of_episodes"
            ],

            numberOfSeasons: json
            [
              "number_of_seasons"
            ],
